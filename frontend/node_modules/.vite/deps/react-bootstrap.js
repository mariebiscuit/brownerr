...
function useUpdateEffect(fn, deps) {
  var isFirst = (0, import_react21.useRef)(true);
...
function useTimeout() {
  ...
  var handleRef = (0, import_react22.useRef)();
...
function useForceUpdate() {
  var _useReducer = (0, import_react24.useReducer)(function(state) {
    return !state;
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react25.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
function useDropdownMenu(options = {}) {
  const context5 = (0, import_react28.useContext)(DropdownContext_default);
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false)
    return ref;
  const warningRef = (0, import_react34.useCallback)((refValue) => {
...
var DropdownMenu2 = React35.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react35.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react35.useContext)(DropdownContext_default2);
...
var DropdownToggle2 = React36.forwardRef(({
  ...
  const dropdownContext = (0, import_react36.useContext)(DropdownContext_default);
...
var ModalDialog = React65.forwardRef(({
  ...
  return (0, import_jsx_runtime63.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames39.default)(dialogClass, className, size && `${bsPrefix}-${size}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
...
var Modal2 = React68.forwardRef(({
  ...
  const renderBackdrop = (0, import_react54.useCallback)((backdropProps) => (0, import_jsx_runtime67.jsx)("div", {
    ...backdropProps,
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react59.useMemo)(function() {
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime87.jsxs)(import_jsx_runtime86.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react67.cloneElement)(children, triggerProps), (0, import_jsx_runtime85.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
